...
func CognitoID(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldCognitoID, v))
}
...
func CognitoIDEQ(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldCognitoID, v))
}

// CognitoIDNEQ applies the NEQ predicate on the "cognito_id" field.
func CognitoIDNEQ(v string) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldCognitoID, v))
}

// CognitoIDIn applies the In predicate on the "cognito_id" field.
func CognitoIDIn(vs ...string) predicate.User {
	return predicate.User(sql.FieldIn(FieldCognitoID, vs...))
}

// CognitoIDNotIn applies the NotIn predicate on the "cognito_id" field.
func CognitoIDNotIn(vs ...string) predicate.User {
	return predicate.User(sql.FieldNotIn(FieldCognitoID, vs...))
}

// CognitoIDGT applies the GT predicate on the "cognito_id" field.
func CognitoIDGT(v string) predicate.User {
	return predicate.User(sql.FieldGT(FieldCognitoID, v))
}

// CognitoIDGTE applies the GTE predicate on the "cognito_id" field.
func CognitoIDGTE(v string) predicate.User {
	return predicate.User(sql.FieldGTE(FieldCognitoID, v))
}

// CognitoIDLT applies the LT predicate on the "cognito_id" field.
func CognitoIDLT(v string) predicate.User {
	return predicate.User(sql.FieldLT(FieldCognitoID, v))
}

// CognitoIDLTE applies the LTE predicate on the "cognito_id" field.
func CognitoIDLTE(v string) predicate.User {
	return predicate.User(sql.FieldLTE(FieldCognitoID, v))
}

// CognitoIDContains applies the Contains predicate on the "cognito_id" field.
func CognitoIDContains(v string) predicate.User {
	return predicate.User(sql.FieldContains(FieldCognitoID, v))
}

// CognitoIDHasPrefix applies the HasPrefix predicate on the "cognito_id" field.
func CognitoIDHasPrefix(v string) predicate.User {
	return predicate.User(sql.FieldHasPrefix(FieldCognitoID, v))
}

// CognitoIDHasSuffix applies the HasSuffix predicate on the "cognito_id" field.
func CognitoIDHasSuffix(v string) predicate.User {
	return predicate.User(sql.FieldHasSuffix(FieldCognitoID, v))
}

// CognitoIDIsNil applies the IsNil predicate on the "cognito_id" field.
func CognitoIDIsNil() predicate.User {
	return predicate.User(sql.FieldIsNull(FieldCognitoID))
}

// CognitoIDNotNil applies the NotNil predicate on the "cognito_id" field.
func CognitoIDNotNil() predicate.User {
	return predicate.User(sql.FieldNotNull(FieldCognitoID))
}

// CognitoIDEqualFold applies the EqualFold predicate on the "cognito_id" field.
func CognitoIDEqualFold(v string) predicate.User {
	return predicate.User(sql.FieldEqualFold(FieldCognitoID, v))
}

// CognitoIDContainsFold applies the ContainsFold predicate on the "cognito_id" field.
func CognitoIDContainsFold(v string) predicate.User {
	return predicate.User(sql.FieldContainsFold(FieldCognitoID, v))
}
